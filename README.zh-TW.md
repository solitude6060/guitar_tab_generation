...
依環境可使用 console script 或 module 形式：

```bash
guitar-tab-generation transcribe fixtures/simple_chords_30_90s.wav --out out/simple_chords
PYTHONPATH=src python3 -m guitar_tab_generation.cli transcribe fixtures/simple_chords_30_90s.wav --out out/simple_chords
```
